...
import TranslationJourney from './TranslationJourney';
  ...
  return (
    ...
    >
      ...
      <div className="translation-steps">
        <h3>🎯 Classical Transformation Journey</h3>
      ...
      {/* Translation Journey Details */}
      <AnimatePresence>
        {showJourney && (
          <TranslationJourney translation={translation} />
        )}
      </AnimatePresence>
      ...
      <div className="stats">
        <div className="stat">
          <span className="stat-label">Languages Visited:</span>
          <span className="stat-value">{translation.journey.length}</span>
        </div>
        <div className="stat">
          <span className="stat-label">Original Words:</span>
          <span className="stat-value">{translation.original.split(' ').length}</span>
        </div>
        <div className="stat">
          <span className="stat-label">Final Words:</span>
          <span className="stat-value">{translation.final.split(' ').length}</span>
        </div>
      </div>
    </motion.div>
  );
