...
function generateClassicalJourney(originalText) {
  const stages = [
    ...
    { step: 2, language: 'Shakespearean English', text: transformToClassicalEnglish(originalText) },
    { step: 3, language: 'Middle English', text: '[Middle English transformation]' },
    { step: 4, language: 'Old English', text: '[Old English transformation]' },
    { step: 5, language: 'Latin', text: '[Latin transformation]' },
    { step: 6, language: 'Classical English', text: transformToClassicalEnglish(originalText) }
  ];
